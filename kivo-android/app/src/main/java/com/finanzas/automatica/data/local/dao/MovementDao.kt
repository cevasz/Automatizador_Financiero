...
interface MovementDao {
    ...
    // Fuente reactiva para la UI (Dashboard, lista de Movimientos): Room reemite
    // automaticamente cuando cualquier escritura toca la tabla "movements" —
    // incluida updateConfirmationState() al confirmar/rechazar — sin necesidad de
    // refrescar manualmente cada pantalla que observa movimientos.
    @Query("SELECT * FROM movements ORDER BY date DESC")
