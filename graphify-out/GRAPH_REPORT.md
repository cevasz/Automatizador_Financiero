...
## Corpus Check
- 8 files · ~125,855 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1280 nodes · 2024 edges · 149 communities (67 shown, 82 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 106 edges (avg confidence: 0.81)
- Token cost: 57,230 input · 0 output
...
6. `InvoiceScreen()` - 18 edges
7. `DashboardScreen()` - 17 edges
8. `docs/guia.md` - 17 edges
9. `InvoiceViewModel` - 17 edges
10. `MovementViewModel` - 17 edges

## Surprising Connections (you probably didn't know these)
- `Escaneo de comprobantes por OCR (ML Kit)` --references--> `InvoiceScreen()`  [EXTRACTED]
  docs/PENDIENTES.md → kivo-android/app/src/main/java/com/finanzas/automatica/presentation/ui/screen/InvoiceScreen.kt
- `Layout adaptativo para tablet (diferido)` --conceptually_related_to--> `MovementsListScreen()`  [INFERRED]
  docs/PENDIENTES.md → kivo-android/app/src/main/java/com/finanzas/automatica/presentation/ui/screen/MovementsListScreen.kt
- `Cifrado en reposo de la base de datos` --references--> `FinanzasDatabase`  [EXTRACTED]
...
- `Total/deudas de Facturas con derivedStateOf` --references--> `InvoiceScreen()`  [EXTRACTED]
  docs/PENDIENTES.md → kivo-android/app/src/main/java/com/finanzas/automatica/presentation/ui/screen/InvoiceScreen.kt
...
- **Auditoría de botones huérfanos en AppNavHost** — docs_pendientes_boton_agenda_agregar_contacto, docs_pendientes_boton_movimientos_detalle, docs_pendientes_reactividad_agenda_presupuestos_metas [EXTRACTED 1.00]
- **Sesión 2026-08-15: PDF con contraseña, bug de biometría y versión en app** — docs_pendientes_pdf_password, docs_pendientes_biometria_reset_navegacion, docs_pendientes_version_en_app [EXTRACTED 1.00]
- **Rediseño visual: paleta, splash y navegación (sesión 2026-08-14 madrugada)** — docs_pendientes_paleta_barro_ocre, docs_pendientes_fondo_splash_topografico, docs_pendientes_navegacion_redistribuida [EXTRACTED 1.00]
...
Cohesion: 0.05
Nodes (80): Boolean, Color, Composable, DebtSummary, Botón "Abonar" en Metas de ahorro, Total/deudas de Facturas con derivedStateOf, ImageVector, Invoice (+72 more)
...
Cohesion: 0.06
Nodes (42): Bundle, Class, BiometricLockGate, BiometricPrompt, Bug: biometría reseteaba la navegación al bloquear, Escaneo de comprobantes por OCR (ML Kit), Fondo del splash: curvas topográficas dibujadas a mano, Ilustraciones de marca conectadas a composables (+34 more)

### Community 4 - "Invoice/Debt Data Access"
Cohesion: 0.09
Nodes (21): AppThemePalette, Versión mostrada en la app (BuildConfig), Versionado de la app (versionCode/versionName), JSONArray, JSONObject, Boolean, Modifier, String (+13 more)

### Community 5 - "Movement Data Access (DAO)"
Cohesion: 0.08
Nodes (35): Confirmación con gesto swipe en Movimientos, Layout adaptativo para tablet (diferido), Extractos PDF protegidos con contraseña, Boolean, ByteArray, String, PdfStatementExtractor, cleanEnum() (+27 more)
...
Cohesion: 0.13
Nodes (15): BankEntity, Botón Movimientos: "Detalle" conectado, Int, Boolean, ByteArray, Category, List, Long (+7 more)
...
Cohesion: 0.17
Nodes (20): Botón Agenda: "Agregar contacto" conectado, Reactividad Agenda/Presupuestos/Metas (Flow sobre Room), Agenda, agendaEditRoute(), AppNavHost(), budgetEditRoute(), Budgets, Dashboard (+12 more)
...
Cohesion: 0.12
Nodes (18): docs/brand/ (material de marca), Agenda, app_notifications (centro de notificaciones in-app), BankParser, BiometricAccess, BootReceiver, Regla de limpieza del repo, docs/guia.md (+10 more)
...
Cohesion: 0.14
Nodes (13): Graphify Integration Rule, Graphify Workflow, backend/ (módulo, pendiente), docs/ (documentación viva), Modelo de negocio: núcleo gratuito e ilimitado, graphify-out/ (mapa de dependencias), Flujo de contextualización vía graphify query, kivo-android/ (módulo) (+5 more)
...
Cohesion: 0.29
Nodes (6): BankParser, BaseBankParser, DatePattern, Boolean, Int, String

### Community 31 - "Classification Engine Support"
Cohesion: 0.18
Nodes (5): Cifrado en reposo de la base de datos, FinanzasDatabase, getInstance(), Context, RoomDatabase

### Community 32 - "Classification Engine & Result"
Cohesion: 0.21
Nodes (7): Double, Instant, Long, ParseResult, PaymentMethod, String, LuloParser
...
Cohesion: 0.67
Nodes (3): Celebración de meta lograda (peak-end rule), Rediseño de FinanceCard / IconBadge, Skill mobile-app-ui-design instalado
...
### Community 71 - "Nequi Notification Fixtures"
Cohesion: 0.67
...
## Knowledge Gaps
- **171 isolated node(s):** `AGENDA`, `RULES`, `KEYWORDS`, `HISTORY`, `UNKNOWN` (+166 more)
...
- **Why does `FinanzasDatabase` connect `Classification Engine Support` to `Enrichment Pipeline Logic`, `Budget Data Access`?**
  _High betweenness centrality (0.250) - this node is a cross-community bridge._
- **Why does `SavingsGoalDao` connect `Budgets ViewModel` to `Classification Engine Support`?**
...
- **Should `Android/Kotlin Common Types` be split into smaller, more focused modules?**
