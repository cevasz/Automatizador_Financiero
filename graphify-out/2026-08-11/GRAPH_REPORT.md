...
## Corpus Check
- 76 files · ~24,560 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 783 nodes · 1490 edges · 48 communities (42 shown, 6 thin omitted)
...
- `AppNavHost()` --calls--> `FinanceTag()`  [INFERRED]
  app/src/main/java/com/finanzas/automatica/presentation/navigation/AppNavHost.kt → app/src/main/java/com/finanzas/automatica/presentation/ui/components/FinanceUi.kt
- `AppNavHost()` --calls--> `IconBadge()`  [INFERRED]
  app/src/main/java/com/finanzas/automatica/presentation/navigation/AppNavHost.kt → app/src/main/java/com/finanzas/automatica/presentation/ui/components/FinanceUi.kt
...
Cohesion: 0.17
Nodes (22): Movement, cleanEnum(), DashboardPeriod, Day, Month, Week, DashboardScreen(), Color (+14 more)
...
Cohesion: 0.11
Nodes (12): BudgetDao, Flow, Int, List, Long, BudgetEntity, FinanzasDatabase, getInstance() (+4 more)
...
Cohesion: 0.36
Nodes (10): EmptyState(), FinanceTag(), IconBadge(), Color, ImageVector, Modifier, String, Unit (+2 more)
...
Cohesion: 0.09
Nodes (15): Flow, Int, List, Long, SavingsGoalDao, SavingsGoalEntity, toDomain(), toEntity() (+7 more)
...
Cohesion: 0.32
Nodes (10): AgendaEntry, Category, AddEditAgendaEntryScreen(), AgendaEntryCard(), AgendaScreen(), cleanEnum(), List, Modifier (+2 more)
...
Cohesion: 0.30
Nodes (11): BudgetCard(), BudgetDetailScreen(), BudgetsScreen(), List, Long, Modifier, NumberFormat, String (+3 more)
...
Cohesion: 0.29
Nodes (6): AppNavHost(), Boolean, Modifier, String, Unit, LoginScreen()
...
- **Why does `AppNavHost()` connect `AppNavHost` to `.buildRawMovement`, `AgendaEntryEntity`, `PaymentMethod`, `Converters`, `BudgetDao`, `SavingsGoalDao`, `DashboardScreen`, `MovementProcessorService`, `gradlew`, `build.gradle.kts`, `FinanceCard`, `build.gradle.kts`, `settings.gradle.kts`, `Category`, `BudgetCard`, `SimpleTest`, `SettingRow`?**
  _High betweenness centrality (0.340) - this node is a cross-community bridge._
- **Why does `FinanzasDatabase` connect `PaymentMethod` to `CategoryEntity`, `ClassificationRuleDao`, `FinanzasDatabase`, `AppNavHost`, `DashboardScreen`?**
  _High betweenness centrality (0.254) - this node is a cross-community bridge._
- **Why does `MovementEntity` connect `NotificationCaptureService` to `PaymentMethod`, `DashboardScreen`, `.classify`?**
