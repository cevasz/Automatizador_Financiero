...
/**
 * Feedback tactil: el elemento se encoge muy levemente mientras se presiona.
 * Sustituye al clickable simple para que las tarjetas interactivas se sientan vivas.
 */
